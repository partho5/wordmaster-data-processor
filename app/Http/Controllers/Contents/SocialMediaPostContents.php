...
class FacebookPagePostingHelper{
    ...
    public function getWordWrittenOnBgPath(){
        /* In Laravel we are to run: php artisan storage:link
         * this command to make Storage::path("/public") work.
         * But for jovoc.com shared hosting I had to run: ln -s /home/jovoccom/public_html/jovoc/storage/app/public /home/jovoccom/public_html/storage.
    ...
    public function postInJovoc($content, $additionalData = null){
        ...
        if($additionalData !== null && isset($additionalData['word'])){
             ...
             * */
            $imagePath = $_SERVER['HTTP_HOST'].'/storage/'.($this->wordWrittenOnBgPath);
